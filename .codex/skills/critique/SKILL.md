...
- **Suggested command**: Which command could address this (from: $quieter, $polish, $optimize, $critique, $audit, $overdrive, $animate, $bolder, $colorize, $typeset, $harden, $shape, $delight, $adapt, $clarify, $layout, $distill)
...
- Only recommend commands from: $quieter, $polish, $optimize, $critique, $audit, $overdrive, $animate, $bolder, $colorize, $typeset, $harden, $shape, $delight, $adapt, $clarify, $layout, $distill
