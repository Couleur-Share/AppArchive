...
export const clerkEnabled = ref(!!publishableKey);

let clerk: Clerk | null = null;

export const initClerk = async (app: App) => {
        if (!publishableKey) {
                logger.warn("Clerk Publishable Key not configured. Authentication disabled.");
        ...
        try {
                ...
                app.config.globalProperties.$clerk = {
                        openSignIn: async () =>
                                (await clerk?.openSignIn({})) || Promise.resolve(),
