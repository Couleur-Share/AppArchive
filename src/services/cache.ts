...
export const cacheService = {
  ...
  async getAnalysisCache(software: Software) {
    return this.get<{ description?: string; pros: string[]; cons: string[]; systems?: string[] }>(`analysis_${software.id}`)
  },

  async setAnalysisCache(software: Software, result: { description?: string; pros: string[]; cons: string[]; systems?: string[] }) {
