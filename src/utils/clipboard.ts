...
export async function copyToClipboard(text: string): Promise<void> {
  ...
  try {
    const anyNavigator: any = typeof navigator !== 'undefined' ? navigator : undefined
    if (typeof window !== 'undefined' && window.isSecureContext && anyNavigator && anyNavigator.clipboard && typeof anyNavigator.clipboard.writeText === 'function') {
